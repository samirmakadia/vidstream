...
- Permission denied errors indicate Firestore rules issues
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          // Floating avatar positioned absolutely
  ...
  Widget _buildProfileInfoWithoutAvatar() {
    return SliverToBoxAdapter(
      child: Container(
        margin: const EdgeInsets.only(left: 16, right: 16, bottom: 16, top: 50),
        child: Column(
          children: [
            const SizedBox(height: 10), // Space for the floating avatar
  ...
  Widget _buildFloatingAvatar() {
    return Positioned(
      top: 200, // Position it to overlap the banner area
