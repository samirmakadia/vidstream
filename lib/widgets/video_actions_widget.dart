...
class VideoActionsWidget extends StatelessWidget {
  ...
  void _showComments(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => CommentsBottomSheet(videoId: video.id),
    );
  }
  ...
  void _showVideoOptions(BuildContext context) {
    ...
    final isOwner = currentUserId == video.userId;
  ...
  Future<void> _deleteVideo(BuildContext context) async {
    ...
    if (confirmed == true) {
      try {
        await ApiRepository.instance.videos.deleteVideo(video.id);
        if (context.mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
  ...
  Future<void> _addComment() async {
    ...
    try {
      await _commentService.createComment(
        ...
        text: text,
        parentCommentId: _replyingTo?.id, // Set parent if replying
      );
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return FutureBuilder<ApiUser?>(
                            future: ApiRepository.instance.auth.getUserProfile(comment.userId),
